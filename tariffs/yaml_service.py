...
class TariffYAMLExporter:
    ...
    def _serialize_energy_charge(self, charge: EnergyCharge) -> dict:
        ...
        return {
            'name': charge.name,
            'rate_usd_per_kwh': float(charge.rate_usd_per_kwh),
            ...
            'applies_start_date': charge.applies_start_date.isoformat() if charge.applies_start_date else None,
            'applies_end_date': charge.applies_end_date.isoformat() if charge.applies_end_date else None,
    ...
    def _serialize_demand_charge(self, charge: DemandCharge) -> dict:
        ...
        return {
            'name': charge.name,
            'rate_usd_per_kw': float(charge.rate_usd_per_kw),
            'period_start_time_local': charge.period_start_time_local.strftime('%H:%M'),
            'period_end_time_local': charge.period_end_time_local.strftime('%H:%M'),
    ...
    def _serialize_customer_charge(self, charge: CustomerCharge) -> dict:
        ...
        return {
            'name': charge.name,
            'usd_per_month': float(charge.usd_per_month),
        }
